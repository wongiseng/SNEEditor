...
var SNE  = {
	...
	repositories : [
	            ...
	            //  {el : "module-ndl_domain", 		repositoryName : "sne _ndl_domain",		label : "NDL Domain",		sesameURL: "http://dev.adaptivedisclosure.org/openrdf-sesame"},
	            ...
	            //  {el : "module-wgs84", 			repositoryName : "wgs84_pos",			label : "WGS84 Position",	sesameURL: "http://dev.adaptivedisclosure.org/openrdf-sesame"},
	                {el : "NOVI",		 			repositoryName : "NOVI",			label : "NOVI Information Model",		sesameURL: "http://dev.adaptivedisclosure.org/openrdf-sesame"},
	                {el : "NOVI-MN",		 		repositoryName : "NOVI-MN",			label : "NOVI Monitoring",				sesameURL: "http://dev.adaptivedisclosure.org/openrdf-sesame"}
	],
